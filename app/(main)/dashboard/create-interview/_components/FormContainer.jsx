     ...
     return (
          <div className='p-5 bg-white rounded-xl'>
               ...
               <div className='mt-5'>
                    ...
                    <Textarea placeholder="Enter details of job description" className='h-[200px] mt-2'
               ...
               <div className='mt-5'>
                    ...
                    <div className='flex gap-3 flex-wrap mt-2'>
                         {InterviewType.map((type, index) => (
                              <div key = {index} 
                                   className={`flex items-center cursor-pointer gap-2 p-1 px-2 bg-white-50 border border-gray-300 rounded-xl hover:bg-secondary
